...
import type { IDisplayableCharacter, MoveRouteCommand } from "./types/interface/character";
import type { IMoveRouteExecter } from "./types/interface/character/moveRouteCharacter";
export declare class Game_Character extends Game_CharacterBase implements IDisplayableCharacter, IMoveRouteExecter {
