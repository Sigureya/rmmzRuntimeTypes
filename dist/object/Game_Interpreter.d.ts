import type { EventCommand, Operation_AddSub, ParamArray_ShowMessage, ParamArray_SetupChoice, ParamArray_InputNumber, ParamArray_ChangeArmors, ParamArray_PlayMovie, Designation, ParamArray_ScrollTextHeader, ParamArray_Comment, ParamArray_ChangeItems, EventCode, ParamArray_CommonEvent, ParamArray_ControlSwitches, ParamArray_ControlVariables, ParamArray_SelfSwitch, ParamArray_Label, ParamArray_ChangeWeapons, AudioFileParams, ParamArray_ChangeActorText, ParamArray_ChangeEnabled, ParamsArray_ShowPicture, ColorRGBA, ParamArray_BattleProcessing, ParamArray_ChangeActorImages, ParamArray_ChangeActorLevel, ParamArray_ChangeActorState, ParamArray_ChangeBattleBackground, ParamArray_ChangeClass, ParamArray_ChangeEnemyParameters, ParamArray_ChangeExp, ParamArray_ChangeParallax, ParamArray_ChangeSkill, ParamArray_ChangeTileset, ParamArray_ChangeVehicleImage, ParamArray_EnemyAppear, ParamArray_EnemyRecoverAll, ParamArray_EnemyTransfrom, ParamArray_EraseEvent, ParamArray_FadeOutAudio, ParamArray_GetLocationInfo, ParamArray_MovementRoute, ParamArray_PluginCommandMV, ParamArray_RotatePicture, ParamArray_Script, ParamArray_ScrollMap, ParamArray_SetEventLocation, ParamArray_SetVehicleLocation, ParamArray_ShopProcessing, ParamArray_ShowAnimation, ParamArray_ShowBalloonIcon, ParamArray_TintPicture, ParamArray_TintScreen, ParamArray_Wait, ParamArray_WeatherEffect, ParamsArray_MovePicture, ParamArray_ChangeActorHP, ParamArray_ChangeActorMP, ParamArray_ChangeActorTP, ParamArray_ChangeEnemyState, ParamArray_ChangeMapNameDisplay, ParamArray_ChangeParam, ParamArray_ChangePartyMember, ParamArray_ControlTimer, ParamArray_ErasePicture, ParamArray_ShakeScreen, ParamArray_ShowBattleAnimation, ParamArray_TransferPlayer, BranchParameters, ParamArray_ChangePlayerFollowers, ParamArray_ChangeTransparency, ParamArray_OpenMenu, ParamArray_SelectItem, ParamArray_RecoverAll, ParamArray_BranchElse, ParamArray_NameInputProcessing, ParamArray_ChangeGold, ParamArray_ChangeVehicleBGM, ParamArray_PluginCommandMZ } from "@sigureya/rpgtypes";
