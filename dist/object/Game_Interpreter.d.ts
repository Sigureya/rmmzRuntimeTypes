...
export declare class Game_Interpreter extends Game_EventCommandExecuter {
    ...
    iterateActorEx(param1: ConstatnOrVariable, param2: number, callback: (actor: Game_Actor) => void): void;
     ...
     * @param operand
     */
    operateValue(operation: typeof OPERATION.ADD | typeof OPERATION.SUB, operandType: ConstatnOrVariable, operand: number): number;
