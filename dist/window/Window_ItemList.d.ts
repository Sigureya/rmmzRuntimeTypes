...
export declare class Window_ItemList extends Window_Selectable implements ISelectable<Data_NamedItem> {
    ...
    numberWidth(): number;
    drawItemNumber(item: Data_NamedItem, x: number, y: number, width: number): void;
    updateHelp(): void;
    refresh(): void;
}
