...
export interface PluginManager_Interface {
    ...
    registerCommand(pluginName: string, commandName: string, func: Function): void;
    callCommand(self: Game_Interpreter, pluginName: string, commandName: string, args: Record<string, string>): void;
}
